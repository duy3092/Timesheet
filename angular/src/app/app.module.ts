...
let config = new AuthServiceConfig([
  {
    ...
    provider: new GoogleLoginProvider(AppConsts.googleClientAppId != '' ? AppConsts.googleClientAppId : '879411761479-pn61p1djcsqldglkqj4kb1bam864tcst.apps.googleusercontent.com' )
  }
]);
